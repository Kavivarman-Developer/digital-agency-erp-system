      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 p-14 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white leading-tight mb-4">
            Join QuickShop,<br />
            <span className="text-indigo-200">start shopping.</span>
          </h1>
          <p className="text-indigo-200 text-sm leading-relaxed mb-10 max-w-sm">
            Create your free account and get access to exclusive products, fast checkout, and live order tracking.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
            ...
            {/* Role badge — fixed, readonly */}
            <div className="mb-6 flex items-center gap-2.5 px-3 py-2.5 bg-indigo-50 border border-indigo-100 rounded-xl">
              <span className="text-lg">🛍️</span>
              <div>
                <p className="text-xs font-semibold text-indigo-700">Customer Account</p>
                <p className="text-xs text-indigo-400">Browse, order & track deliveries</p>
              </div>
            </div>
          ...
          <p className="mt-5 text-center text-sm text-slate-400">
            ...
            <Link to="/shop/login" className="text-indigo-600 font-medium hover:underline">
              Sign in
            </Link>
          </p>
