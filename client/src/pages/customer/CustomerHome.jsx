    ...
    <div className="min-h-screen bg-[#f1f3f6]">
      ...
      {showModal && (
        <LoginModal
          ...
          onLogin={() => navigate("/shop/login", { state: { from: "/shop" } })}
        />
      )}
        ...
        {wishlist.length > 0 && (
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-400">
              ...
              {!isLoggedIn && <span className="ml-1 text-[#2874f0] font-medium cursor-pointer hover:underline" onClick={() => navigate("/shop/login")}> — Sign in to save across devices</span>}
            </p>
          </div>
        )}
      </div>
