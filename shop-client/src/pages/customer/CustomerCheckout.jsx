    ...
    return (
      <div className="min-h-screen bg-[#f1f3f6] flex flex-col items-center justify-center gap-4 p-6">
        <div className="bg-white rounded-xl shadow-sm p-12 text-center max-w-sm w-full">
          ...
          <Link to="/" className="bg-[#2874f0] text-white px-8 py-2.5 rounded-sm font-bold text-sm block">
            Go to Shop
          </Link>
        </div>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
              <div className="px-4 py-3 border-b border-slate-50 flex items-center justify-between">
                ...
                <Link to="/cart" className="text-xs text-[#2874f0] font-bold hover:underline">Edit</Link>
              </div>
